 ...
 *
 * @param mixed $input El valor a comprobar.
 * @return bool Devuelve true si el valor es un entero positivo, false en caso contrario.
 */
function esEnteroPositivo($input) {
    return is_numeric($input) && $input >= 0 && $input == round($input);
}
//OSWALDO DOMINGO PÉREZ
